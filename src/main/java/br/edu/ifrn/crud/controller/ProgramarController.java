...
public class ProgramarController {
	...
	//Metodo para alterar programaçoes ja cadastradas
	...
	//Metodo para remover programações cadastradas
	@SuppressWarnings({})
	...
	//metodo  preenchimento automático autocompleteDTO
	...
	//Metodo que mostra um menu pop-up dos dias da semana
	@ModelAttribute("dia")
